...
public enum ErrorCode{
    ...
    AI_RECOMMENDATION_UNSUPPORTED_INTENT(13, "AI 추천은 빠른길, 자전거 종류, 난이도/오르막 회피, 포장도로, 자전거도로 우선, 큰도로 회피, 계단·물길·빙판·공사구간 회피, 거리 제한, 구체적인 장소명 경유만 지원합니다.", HttpStatus.BAD_REQUEST),
